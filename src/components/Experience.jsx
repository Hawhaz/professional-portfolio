...
// Optimizar ExperienceCard con memo para evitar re-renderizados innecesarios
        ...
        <ul className="mt-5 list-disc ml-5 space-y-2">
          {experience.points.map((point, index) => (
            <li
              ...
              className="text-taupe text-[16px] pl-1 tracking-wider"
            >
              {point}
            </li>
          ))}
    ...
    <>
      ...
      <div className="mt-20 flex flex-col">
        <VerticalTimeline 
          ...
          animate={!isMobile} // Desactivar animaciones en dispositivos móviles
        >
